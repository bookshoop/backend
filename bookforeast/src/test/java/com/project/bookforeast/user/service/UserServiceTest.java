...
public class UserServiceTest {
	...
	public void userSaveSuccess_Social() {
		...
		// when
		UserDTO savedUser = userService.socialLogin(userDTO);
	...
	public void userSaveSuccess() {
		...
		// when
 		final User result = userService.socialUserSave(userDTO);
...
//	}
	...
	public void userSaveFailNessaryValueNotExust() {
		...
		// when
		final UserException result = assertThrows(UserException.class, () -> userService.socialUserSave(userDTO));
